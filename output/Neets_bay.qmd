...
# model
tag_dat <- tibble(
  year = rep(c(2023, 2024, 2025), each = 3), # return year
  group = rep(c("control", "net", "tender"), 3),
  terminal = c(327, 258, 338, 150, 550, 227, 450, 100, 157), 
  non_terminal = c(205, 178, 239, 200, 170, 230, 250, 275, 276),
  total = terminal + non_terminal)
...
print(as.data.frame(fixef_results))

# pairwise comparison
pairs(emmeans(home_random, ~ group, type = "fixed")) %>%
  summary(infer = TRUE, transform = "response")
```
